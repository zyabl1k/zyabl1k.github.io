...
const Rules2 = "При нажатии на кнопку ты получаешь случайную загадку. У тебя будет 3 попытки написать правильный ответ. В случае правильного ответа ты получаешь приятные слова, если проиграешь, то загадка меняется. Вопросы могут повторятся, прости уж(";
